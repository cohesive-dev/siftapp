...
import { BsBriefcase, BsChatDots, BsQuestionDiamond } from 'react-icons/bs';
...
const routesConfig = [
  {
    ...
    children: [
      ...
      },*/
      {
        id: 'fund-I',
        title: 'Fund I',
        messageId: 'sidebar.app.dashboard.fundI',
        type: 'collapse',
        icon: <MdOutlineAnalytics />,
        url: '/dashboards/fund/1',
        children: [
          {
            id: 'companyA',
            title: 'Company A',
            messageId: 'sidebar.app.dashboard.companyA',
            type: 'item',
            icon: <RiSuitcaseLine />,
            url: '/dashboards/company/1',
          },
          {
            id: 'crm',
            title: 'CRM',
            messageId: 'sidebar.app.dashboard.companyB',
            type: 'item',
            icon: <RiSuitcaseLine />,
            url: '/dashboards/company/2',
          },
          {
            id: 'crm',
            title: 'CRM',
            messageId: 'sidebar.app.dashboard.companyC',
            type: 'item',
            icon: <RiSuitcaseLine />,
            url: '/dashboards/company/3',
          }
        ]
      },
      {
        id: 'analytics',
        title: 'Analytics',
        messageId: 'sidebar.app.dashboard.fundII',
        type: 'collapse',
        icon: <MdOutlineAnalytics />,
        url: '/dashboards/fund/2',
        children: [
          {
            id: 'companyA',
            title: 'Company A',
      ...
      },
      {
        id: 'analytics',
        title: 'Analytics',
        messageId: 'sidebar.app.dashboard.fundIII',
        type: 'collapse',
        icon: <MdOutlineAnalytics />,
        url: '/dashboards/fund/3',
        children: [
          {
            id: 'companyA',
            title: 'Company A',
      ...
      },
      {
        id: 'analytics',
        title: 'Analytics',
        messageId: 'sidebar.app.dashboard.fundIV',
        type: 'collapse',
        icon: <MdOutlineAnalytics />,
        url: '/dashboards/fund/4',
        children: [
          {
            id: 'companyA',
            title: 'Company A',
