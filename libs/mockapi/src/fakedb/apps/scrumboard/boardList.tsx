    ...
    list: [
      {
        ...
        cards: [
          ...
          },
          {
            ...
            label: [
              { id: 303, name: 'Sift', type: 3, color: 'primary.main' },
      ...
      },
      {
        ...
        cards: [
          {
            id: 5001,
            title: 'Call Adam to review the Sift ThemeProvider documentation',
            attachments: [],
            label: [
              { id: 303, name: 'Sift', type: 3, color: 'primary.main' },
              { id: 301, name: 'High Priority', type: 1, color: 'red' },
          ...
          },
          {
            ...
            attachments: [],
            label: [{ id: 303, name: 'Sift', type: 3, color: 'primary.main' }],
