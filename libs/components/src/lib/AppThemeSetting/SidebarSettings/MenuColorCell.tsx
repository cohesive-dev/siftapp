...
import {
  ...
  useSidebarContext,
} from '@sift/context/SidebarContextProvider';
import { MenuStyle, NavStyle, ThemeMode } from '@sift/constants/AppEnums';
...
import { SidebarData } from '@sift/constants/defaultConfig';
